...
// BST.h
// 10/20/2020
// Specification and Implementation file for the BST class having different
// functions like insert, remove, contains, empty, size, getLevel, getLeafCount,
// getHeight, getInOrderTraversal, getPreOrderTraversal, getPostOrderTraversal
...
bool BST<T>::getAncestors(Node *root, T target)
{
    ...
    /* If target is present in either left or right subtree of this node,
       then append this node in sstream */
