...
// PROGRAM: p1.cpp
// DATE:    09/29/2020
// PURPOSE: This program keeps the track of information regarding Book
//          Recommendations. This program provides many functionalities to the
//          user like Add a new member, Add a new book, Rate book, View
//          ratings, See recommendations after user successfully logged in
// INPUT:   Files books.txt, ratings.txt, User inputs like Member name, rating,
//          author name, book title, year.
// PROCESS: Run the different menus selected by user.
// OUTPUT:  Prints the output of different menus provided by user.
...
// IN: BookList *bookList, MemberList *memberList, RatingList *ratingList
// MODIFY: none
// OUT: none
...
// To read books from input file
// IN: BookList *list, string basicString, int isbnNumber
// MODIFY: none
// OUT: none

void readRatingsFromInputFile(MemberList *memberList, RatingList *ratingList,
                                            string fileName, int accountNumber);
// To read ratings from input file
// IN: MemberList *memberList, RatingList *ratingList,
//                                          string fileName, int accountNumber
// MODIFY: none
// OUT: none
...
// To rate Book
// IN: BookList *bookList, MemberList *memberList, RatingList
//                                              *ratingList, int accountNumber
// MODIFY: none
// OUT: none
...
// To display Account Ratings
// IN: BookList *bookList, MemberList *memberList,
//                                    RatingList *ratingList, int accountNumber
// MODIFY: none
// OUT: none
...
int main()
{
    const int SIZE = 100;                        // To hold SIZE
    int accountNumber = 1;                       // To hold accountNumber
    string booksFile = "books.txt";              // To hold booksFile
    string ratingsFile = "ratings.txt";          // To hold ratingsFile
    int isbnCounter = 1;                         // To hold isbnCounter
    ifstream myFile;                             // To hold myFile
